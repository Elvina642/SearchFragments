...
В отличие от метода установки, описанного в курсовой работе, текущая версия программы является самодостаточной (standalone) и не требует инсталляции или наличия стороннего ПО на компьютере.
1. Перейдите в раздел [![Realeses]](https://github.com/Elvina642/SearchFragments/releases).
2. Скачайте архив или напрямую файл SearchFragments.exe.
3. Запустите скачанный файл. Программа готова к работе сразу после запуска.
4. Нажмите кнопку «Загрузить файл», настройте параметры поиска и нажмите «Поиск».

---

## 📄 Документация
Подробное описание разработки, алгоритмов и руководство пользователя доступны в следующих файлах:
* [Курсовая работа](docs/Coursework.pdf) — содержит теоретический анализ, сравнение алгоритмов и результаты тестирования.
* [Презентация проекта](docs/Presentation.pdf) — краткий обзор ключевых возможностей и стека технологий.
